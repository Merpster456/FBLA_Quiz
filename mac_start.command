...
test -d /Library/Java/JavaVirtualMachines/jdk-15* && java_path="/Library/Java/JavaVirtualMachines/jdk-15.0.2.jdk" || java_path=$(find / -type d -name jdk-15*.jdk 2>/dev/null)
